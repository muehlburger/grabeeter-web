          ...
          <div id="wrapper">
                    ...
                    <h2>Katalog</h2>
                              ...
                              <div class="contactform">
                                        ...
                                        <div class="contactleft"><label for="ISBN">ISBN: </label></div>
                                        <div class="contactright"><input name="ISBN" id="ISBN" onchange="getCompleteInput();" class="passive" onkeydown="getFetchedInput();" size="30" maxlength="50" value="" type="text" /> <span class="required">*</span></div>
          				...
          				<tr>
          					...
          					<th>
          						Preis (EUR)
                                        ...
                                        <div id="separatorBottom"></div>
                                        
                                        <div class="contactleft"><label for="Feedback">Rückmeldung: </label></div>
                                        <div class="contactright"><textarea name="Feedback" id="Feedback" cols="35" rows="8"></textarea>
                                        </div>
                                        <div class="contactleft"><label for="Email">Email:</label></div>
                                        <div class="contactright"><input name="Email" id="Email" size="30" maxlength="50" value="" type="text" /> <span class="required">*</span></div>
                                        <div class="contactright"><input name="submit" value="Absenden!" id="subm" type="submit"></div>
