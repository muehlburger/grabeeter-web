...
abstract class BaseTweetUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'last_saved_tweet_id' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'last_saved_tweet_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
