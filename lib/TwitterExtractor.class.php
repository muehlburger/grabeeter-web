...
class Twitter_Extractor {
	...
	public static function extractAll($tweet) {
		return array(
	...
	public static function extractHashtags($tweet) {
		preg_match_all('$(^|[^0-9A-Z&/]+)([#＃]+)([0-9A-Z_]*[A-Z_]+[a-z0-9_üÀ-ÖØ-öø-ÿ]*)$i', $tweet, $matches);
		return $matches[3];
	}

	public static function extraclURLS($tweet) {
	...
	public static function extractReplyScreenname($tweet) {
