...
<p>It is also possible to enter a time period to filter your tweets. Just enter the start of the time peroid into the 
intended textfield "From" and the end of the peroid into the intended textfield "To".</p>

<h3>How can I save my tweets?</h3>
<p>
There are two possibilities to store or export your tweets. 
</p>
...
<p>Open your software controlpanel, look for Grabeeter and click on button "Remove" or "Deinstall"; confirm.</p>