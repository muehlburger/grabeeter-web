...
<ul>
<li>http://www.grabeeter.dat/frontend_dev.php/api/tweets/{twitter-username}.xml</li>
<li>http://www.grabeeter.dat/frontend_dev.php/api/tweets/{twitter-username}.json</li>
</ul>
...
<ul>
<li><?php echo link_to('http://www.grabeeter.dat/frontend_dev.php/api/tweets/hmuehlburger.xml', '@api_tweets?screen_name=hmuehlburger&sf_format=xml', array('target' => '_blank')) ?></li>
<li><?php echo link_to('http://www.grabeeter.dat/frontend_dev.php/api/tweets/hmuehlburger.json', '@api_tweets?screen_name=hmuehlburger&sf_format=json', array('target' => '_blank')) ?></li>
</ul>
